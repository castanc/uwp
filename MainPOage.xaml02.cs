...
namespace Deskhelp_UWP
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            Microsoft.ApplicationInsights.WindowsAppInitializer.InitializeAsync(dhp.AppInsightsKey);
        ...
        public MainPage()
        {
            ...
            Window.Current.CoreWindow.SizeChanged += async (ss, ee) =>
            {
                ...
                appView.TryResizeView(new Size(400, 500));
                ee.Handled = true;
            };
        }
